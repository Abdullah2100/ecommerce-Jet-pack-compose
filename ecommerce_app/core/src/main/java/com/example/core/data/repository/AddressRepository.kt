...
class AddressRepository(private val client: HttpClient, private val authDao: AuthDao) :
    ...
    override suspend fun userAddNewAddress(locationData: CreateAddressDto): NetworkCallHandler =
    ...
    override suspend fun userUpdateAddress(locationData: UpdateAddressDto): NetworkCallHandler =
        withContext(Dispatchers.IO) {
            val authData =
                getAuthData()
                    ?: return@withContext NetworkCallHandler.Error("user is not authenticate ")
    ...
    override suspend fun deleteUserAddress(addressID: UUID): NetworkCallHandler =
        withContext(Dispatchers.IO) {
            val authData =
                getAuthData()
                    ?: return@withContext NetworkCallHandler.Error("user is not authenticate ")
    ...
    override suspend fun setAddressAsCurrent(addressId: UUID): NetworkCallHandler =
        withContext(Dispatchers.IO) {
            val authData =
                getAuthData()
                    ?: return@withContext NetworkCallHandler.Error("user is not authenticate ")
    ...
    override suspend fun getStoreAddress(id: UUID, pageNumber: Int): NetworkCallHandler =
        withContext(Dispatchers.IO) {
            val authData =
                getAuthData()
                    ?: return@withContext NetworkCallHandler.Error("user is not authenticate ")
